 ...
 */
@WebServlet("/FetchMenServlet2")
public class FetchMenServlet2 extends HttpServlet {
	...
	{			
		...
		response.setContentType("text/html");
	       ...
	       out.println("<html>");
	       out.println("<head>");
	       out.println("<title>Servlet Fetch Men </title>");
	       out.println("</head>");
	       out.println("<body>");
		...
		try {
			...
			RequestDispatcher rd = 
		             request.getRequestDispatcher("Men.jsp");
